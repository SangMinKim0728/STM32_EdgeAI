...
# Read The Data
dataset = SF.readData('FanLabelData.txt')
#TEST
#print(dataset)
#while True:
# a=1
...
model.fit(InputTrainingData,OutputTrainingData, validation_split=1-TrainingDataSplitRatio,epochs=50,batch_size=BatchSize,verbose=2)
