...
#define AI_NETWORK_MODEL_SIGNATURE     "d07582a9e6ee55ced44940afc6dc1cb7"
...
#define AI_TOOLS_DATE_TIME   "Fri Jul  1 11:56:20 2022"
...
/* Tensor #2 */
AI_TENSOR_OBJ_DECLARE(
  conv2d_2_conv2d_output0, AI_STATIC,
  2, 0x0,
...
AI_TENSOR_OBJ_DECLARE(
  ...
  9, 0x0,
  AI_SHAPE_INIT(4, 216, 12, 1, 1), AI_STRIDE_INIT(4, 4, 864, 10368, 10368),
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &conv2d_2_conv2d_output0),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &dense_4_dense_output),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 12256, 1, 1),
    12256, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
